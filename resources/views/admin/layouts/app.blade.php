                ...
                <nav class="sb-sidenav accordion sb-sidenav-dark" id="sidenavAccordion">
                    <div class="sb-sidenav-menu">
                        <div class="nav">
                            ...
                            <nav class="sb-sidenav-menu-nested nav"><a class="nav-link" href="{{route('encuestas.admin')}}">Lista de Encuestas</a><a class="nav-link" href="layout-sidenav-light.html">Light Sidenav</a></nav>
                            </div>
                    ...
                    <div class="sb-sidenav-footer">
                        ...
                        <i class="fas fa-user fa-fw mr-2"></i>{{ ucwords(Auth::user()->name) }} <span class="caret"></span>
                    </div>
                </nav>
            </div>
            {{-- contenido --}}
